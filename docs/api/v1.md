...
The base URL for all calls is:
    ...
    https://user:password@yournextcloud.com/index.php/apps/notesplus/api/v1/
...
```bash
curl -u "user:password" "https://yournextcloud.com/index.php/apps/notesplus/api/v1.4/attachment/<id>?path=<path>" -o <outputfilename>.jpg
```
...
curl -u "user:password" \
       ...
       "https://yournextcloud.com/index.php/apps/notesplus/api/v1.4/attachment/<id>"
